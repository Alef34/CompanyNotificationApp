...
namespace CompanyNotificationApp.Services
{
    public class NotificationService
    {
        ...
        private async Task CheckCompanyNotificationsAsync(Company company)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"🔍 Nájdené {pendingNotifications.Count} notifikácií pre {company.Name}");
            ...
            foreach (var notification in pendingNotifications)
            {
                ...
                var task = new NotificationTask
                {
                    ...
                    RelatedOption = CompanyOptionType.Slovakia,
                ...
                // Pošli email (zatiaľ len return)
                await _emailService.SendNotificationAsync(company, task);

                System.Diagnostics.Debug.WriteLine($"📧 Notifikácia spracovaná: {company.Name} - {notification.Description}");

                // ❌ ZATIAĽ NEOZNAČUJ AKO HOTOVÚ!
